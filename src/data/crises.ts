...
const crises: CrisisDefinition[] = [
  ...
  },
  {
    ...
    responses: [
      ...
      },
      {
        ...
        narrative:
          "You handled it with class. Teammates respect that. But you are still on the bench.",
        depthChartChange: null,
        missGames: 0,
      },
    ],
  },
  {
    ...
    responses: [
      ...
      },
      {
        ...
        narrative:
          "You kept your head down. Drama passed eventually. No one saw you step up though.",
        depthChartChange: null,
        missGames: 0,
      },
    ],
  },
  {
    ...
    responses: [
      ...
      },
      {
        ...
        narrative:
          "You buried yourself in football. It helped on the field but the stress is still there.",
        depthChartChange: null,
        missGames: 0,
      },
    ],
  },
  {
    ...
    description:
      "One player on the other side of the ball has been running his mouth about you all week.",
    duration: 2,
