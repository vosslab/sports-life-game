...
export const IHSA_FROSH_SOPH_RULES: LeagueRules = {
	...
	patSuccessRate: 0.7, // miss a lot of extra points
...
export const IHSA_FROSH_SOPH_TUNING: LeagueTuning = {
	...
	kickoffTouchbackRate: 0.2, // weak leg, short kicks
...
export const IHSA_VARSITY_RULES: LeagueRules = {
	...
	patSuccessRate: 0.8, // more reliable than FS
	twoPointRate: 0.4,
};
...
export const IHSA_VARSITY_TUNING: LeagueTuning = {
	...
	upsetFactor: 0.2,
	passRateBase: 0.4, // more passing than FS
	fourthDownAggression: 0.2,
	fieldGoalAccuracy: 0.55, // weak but functional
	completionRate: 0.5, // better but still below college
	sackRate: 0.05,
