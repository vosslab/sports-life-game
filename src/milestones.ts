...
const MILESTONES: Milestone[] = [
	...
	},
	{
		id: 'hs_first_loss',
		phase: 'high_school',
		check: (_player, _wins, losses) => losses >= 1,
		headline: 'First Loss',
	...
	},
	{
		id: 'hs_rivalry_game',
		phase: 'high_school',
		check: (player, _wins) => player.currentWeek >= 8 && _wins >= 5,
	...
	},
	{
		...
		phase: 'high_school',
		check: (player, _wins, losses) => player.currentWeek >= 8 && losses === 0,
	...
	},
	{
		...
		phase: 'nfl',
		check: (player, _wins) => _wins === 1 && player.nflYear === 1,
